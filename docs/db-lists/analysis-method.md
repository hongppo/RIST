...
| `description` | 설명·적용 조건 | 일반 추천·자동입력 방식은 미확정. PDF-002 지정악취 22종은 확정 매칭 가이드 적용. |
...
PDF-002 지정악취 22종은 [PDF-002 분석법 매칭 가이드](<../extraction-rules/pdf/pdf-002.md>)를 따른다. 다른 유형의 자동매칭에는 확대 적용하지 않는다.
